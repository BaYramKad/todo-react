...
function Task({ id, text, completed, list, onRemove, onEdit, onCompleteTask }) {
    const complateTask = (e) => {
  ...
  return (
    ...
    <div className="checkbox">
        <input onChange={complateTask} id={`task-${id}`} type='checkbox' checked={completed} />
